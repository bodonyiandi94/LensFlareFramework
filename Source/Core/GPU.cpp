...
namespace GPU
{
	...
	{
		static glm::ivec2 s_maxResolution = Config::AttribValue("max_resolution").get<glm::ivec2>();
	...
	////////////////////////////////////////////////////////////////////////////////
	template<typename T>
	T mipDimensionsFloorImpl(T textureSize, int lodSize)
	{
		return glm::max(T(1), textureSize / lodSize);
	}
	////////////////////////////////////////////////////////////////////////////////
	template<typename T>
	T mipDimensionsCeilImpl(T textureSize, int lodSize)
	{
		return glm::max(T(1), (textureSize + lodSize - 1) / lodSize);
	}
	...
	{
		return mipDimensionsFloorImpl(textureSize, std::pow(2, lodLevel));
	}
	...
	{
		return mipDimensionsFloorImpl(glm::ivec3(texture.m_width, texture.m_height, texture.m_depth), std::pow(2, lodLevel));
	}
	...
	{
		return mipDimensionsCeilImpl(textureSize, std::pow(2, lodLevel));
	}
	...
	{
		return mipDimensionsCeilImpl(texture.m_dimensions, std::pow(2, lodLevel));
	}
