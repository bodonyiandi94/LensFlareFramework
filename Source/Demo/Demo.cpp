...
namespace Demo
{
	...
	void commonCameraProperties(Scene::Scene& scene, Scene::Object& object, bool locked)
	{
		...
		object.component<Camera::CameraComponent>().m_fovy = glm::radians(75.0f);
		object.component<Camera::CameraComponent>().m_fovyMin = 50.0f;
		object.component<Camera::CameraComponent>().m_fovyMax = 75.0f;
		object.component<Camera::CameraComponent>().m_apertureMethod = Camera::CameraComponent::Fixed;
		object.component<Camera::CameraComponent>().m_fixedAperture = 5.0f;
		object.component<Camera::CameraComponent>().m_apertureMin = 2.0f;
		object.component<Camera::CameraComponent>().m_apertureMax = 7.0f;
		object.component<Camera::CameraComponent>().m_focusDistance = 5.0f;
		object.component<Camera::CameraComponent>().m_focusDistanceMin = 0.1f;
		object.component<Camera::CameraComponent>().m_focusDistanceMax = 5.0f;
		object.component<Camera::CameraComponent>().m_movementSpeed = 4.0f;
	...
	void addCoreObjects(Scene::Scene& scene)
	{
			...
			Scene::extendDefaultObjectInitializerBefore([](Scene::Scene& scene, Scene::Object& object)
		{
			...
			object.component<RenderSettings::RenderSettingsComponent>().m_units.m_unitsPerMeter = 100.0f;
			...
			Scene::extendDefaultObjectInitializerBefore([](Scene::Scene& scene, Scene::Object& object)
		{
			...
			object.component<GuiSettings::GuiSettingsComponent>().m_profilerChartsSettings.m_lineThickness = 2.0f;
			...
			object.component<GuiSettings::GuiSettingsComponent>().m_profilerChartsSettings.m_scaleTicks = { 6, 3 };
			object.component<GuiSettings::GuiSettingsComponent>().m_profilerChartsSettings.m_showLimits = true;
			object.component<GuiSettings::GuiSettingsComponent>().m_profilerChartsSettings.m_showTickLabels = true;
			object.component<GuiSettings::GuiSettingsComponent>().m_profilerChartsSettings.m_nest = false;
		}));
	...
	void addDemoSceneCommonObjects(Scene::Scene& scene, DemoScene const& demoScene)
	{
			...
			Scene::extendDefaultObjectInitializerBefore([&](Scene::Scene& scene, Scene::Object& object)
		{
			...
			object.component<VoxelGlobalIllumination::VoxelGlobalIlluminationComponent>().m_numDiffuseBounces = 4;
			object.component<VoxelGlobalIllumination::VoxelGlobalIlluminationComponent>().m_radianceDecayRate = 0.0f;
			object.component<VoxelGlobalIllumination::VoxelGlobalIlluminationComponent>().m_occlusionDecayRate = 0.3f;
		...
		// Add the post-lightning FXAA.
		auto& fxaaPostLighting = createObject(scene, demoScene.m_name + " FXAA Post Lighting", Scene::OBJECT_TYPE_FXAA, 
			Scene::extendDefaultObjectInitializerBefore([&](Scene::Scene& scene, Scene::Object& object)
		{
			...
			Scene::extendDefaultObjectInitializerBefore([&](Scene::Scene& scene, Scene::Object& object)
		{
			...
			object.component<MotionBlur::MotionBlurComponent>().m_numTaps = 8;
