...
namespace Profiler
{
	...
	////////////////////////////////////////////////////////////////////////////////
	template<typename T>
	T slidingAverage(ProfilerDataEntry& entry, int firstFrame, int lastFrame, bool countNonExistent = true)
	{
		...
		{
			auto it = entry.m_previousValues.find(i);
			if (it != entry.m_previousValues.end())
			{
	...
	////////////////////////////////////////////////////////////////////////////////
	template<typename T>
	T slidingAverageWindowed(ProfilerDataEntry& entry, int frameId, int windowSize, bool countNonExistent = true, bool backward = true, bool forward = true)
	{
	...
	////////////////////////////////////////////////////////////////////////////////
	template<typename T>
	T slidingMin(ProfilerDataEntry& entry, int firstFrame, int lastFrame)
	{
		// Result and number of entries
		T min = T(0);
		bool first = true;
	...
	////////////////////////////////////////////////////////////////////////////////
	template<typename T>
	T slidingMinWindowed(ProfilerDataEntry& entry, int frameId, int windowSize, bool backward = true, bool forward = true)
	{
		// Make sure the window size is odd
		windowSize = (windowSize / 2) * 2 + 1;
	...
	////////////////////////////////////////////////////////////////////////////////
	template<typename T>
	T slidingMax(ProfilerDataEntry& entry, int firstFrame, int lastFrame)
	{
		// Result and number of entries
		T max = T(0);
		bool first = true;
	...
	////////////////////////////////////////////////////////////////////////////////
	template<typename T>
	T slidingMaxWindowed(ProfilerDataEntry& entry, int frameId, int windowSize, bool backward = true, bool forward = true)
	{
		// Make sure the window size is odd
		windowSize = (windowSize / 2) * 2 + 1;
