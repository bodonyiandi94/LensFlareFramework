...
namespace Scene
{
	...
	bool createTexture(Scene& scene, const std::string& textureName, GLenum textureType, int width, int height, int depth, GLenum format, GLenum layout,
		GLenum minFilter = GL_LINEAR, GLenum magFilter = GL_LINEAR, GLenum wrapMode = GL_CLAMP_TO_EDGE, GLenum bindingId = GL_TEXTURE0);
	...
	bool createTexture(Scene& scene, const std::string& textureName, GLenum textureType, int width, int height, GLenum format, GLenum layout,
		GLenum minFilter, GLenum magFilter, GLenum wrapMode, GLenum depthFormat, GLenum bindingId = GL_TEXTURE0);

	////////////////////////////////////////////////////////////////////////////////
	bool createTexture(Scene& scene, const std::string& textureName, GLenum textureType, int width, int height, int depth, GLenum format, GLenum layout,
		GLenum minFilter, GLenum magFilter, GLenum wrapMode, GLenum dataFormat, const void* data, GLenum bindingId = GL_TEXTURE0);
	...
	bool renderTexture(Scene& scene, const std::string& textureName, GLenum textureType, int width, int height, int depth, GLenum format, GLenum layout,
		GLenum minFilter, GLenum magFilter, GLenum wrapMode, std::string const& shaderName, GLenum bindingId = GL_TEXTURE0);
	...
	////////////////////////////////////////////////////////////////////////////////
	bool createGPUBuffer(Scene& scene, const std::string& bufferName, GLenum bufferType, bool immutable = false, bool indexed = false, GLuint bindingId = 0, GLenum flags = 0, GLsizeiptr storageSize = 0, GLsizeiptr elementSize = 0);
	...
	////////////////////////////////////////////////////////////////////////////////
	template<typename T>
	bool createGPUBuffer(Scene& scene, const std::string& bufferName, GLenum bufferType, bool immutable, bool indexed, GLuint bindingId, GLenum flags, std::vector<T> const& data)
	{
