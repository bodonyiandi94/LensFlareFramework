...
namespace GuiSettings
{
	...
	struct ProfilerChartsSettings
	{
		...
		// How many scale ticks to draw
		glm::ivec2 m_scaleTicks = { 10, 3 };

		// Visualize the limits
		bool m_showLimits = true;

		// Show tick labels
		bool m_showTickLabels = true;

		// Whether we should still show some sneak peak when the chart is collapsed or not
		bool m_showPeakWhenCollapsed = true;
		...
		glm::vec4 m_minPlotColor = glm::vec4{ 0.2f, 0.685f, 0.2f, 1.0f };
		glm::vec4 m_avgPlotColor = glm::vec4{ 0.81f, 0.21f, 0.21f, 1.0f };
		glm::vec4 m_maxPlotColor = glm::vec4{ 0.2f, 0.685f, 0.2f, 1.0f };

		// X grid color
		glm::vec4 m_xGridColor = glm::vec4{ 1.0f, 1.0f, 1.0f, 0.125f };
		glm::vec4 m_xGridLabelColor = glm::vec4{ 1.0f, 1.0f, 1.0f, 1.0f };

		// y grid color
		glm::vec4 m_yGridColor = glm::vec4{ 1.0f, 1.0f, 1.0f, 0.125f };
		glm::vec4 m_yGridLabelColor = glm::vec4{ 1.0f, 1.0f, 1.0f, 1.0f };
