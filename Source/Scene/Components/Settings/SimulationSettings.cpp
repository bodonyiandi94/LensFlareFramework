...
namespace SimulationSettings
{
	...
	void generateGui(Scene::Scene& scene, Scene::Object* guiSettings, Scene::Object* object)
	{
		...
		ImGui::Combo("Reload Resources", (Scene::ResourceType*) &EditorSettings::editorProperty<int>(scene, object, "SimulationSettings_ReloadResourceType"), Scene::ResourceType_meta);
		ImGui::SameLine();
		if (ImGui::Button("Reload"))
		{
			Scene::reloadResources(scene, Scene::ResourceType(EditorSettings::editorProperty<int>(scene, object, "SimulationSettings_ReloadResourceType")));
		}

		if (ImGui::BeginPopup("ObjectGroup_Create"))
		{
		...
		{
			ImGui::OpenPopup("ObjectGroup_Create");
		}
