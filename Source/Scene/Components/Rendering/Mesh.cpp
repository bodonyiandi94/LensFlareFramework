...
namespace Mesh
{
	...
	{
		{
			...
			glUniformMatrix4fv(16, 1, GL_FALSE, glm::value_ptr(model));
			glUniformMatrix4fv(17, 1, GL_FALSE, glm::value_ptr(normal));
			glUniformMatrix4fv(18, 1, GL_FALSE, glm::value_ptr(renderSettings->component<RenderSettings::RenderSettingsComponent>().m_voxelMatrices[0]));
			glUniformMatrix4fv(19, 1, GL_FALSE, glm::value_ptr(renderSettings->component<RenderSettings::RenderSettingsComponent>().m_voxelMatrices[1]));
			glUniformMatrix4fv(20, 1, GL_FALSE, glm::value_ptr(renderSettings->component<RenderSettings::RenderSettingsComponent>().m_voxelMatrices[2]));
			glUniformMatrix4fv(21, 1, GL_FALSE, glm::value_ptr(renderSettings->component<RenderSettings::RenderSettingsComponent>().m_inverseVoxelMatrices[0]));
			glUniformMatrix4fv(22, 1, GL_FALSE, glm::value_ptr(renderSettings->component<RenderSettings::RenderSettingsComponent>().m_inverseVoxelMatrices[1]));
			glUniformMatrix4fv(23, 1, GL_FALSE, glm::value_ptr(renderSettings->component<RenderSettings::RenderSettingsComponent>().m_inverseVoxelMatrices[2]));
		}
	...
	void shadowMapOpenGL(Scene::Scene& scene, Scene::Object* simulationSettings, Scene::Object* renderSettings, Scene::Object* camera, std::string const& functionName, Scene::Object* object)
	{
		...
		for (size_t sliceId = 0; sliceId < slices.size(); ++sliceId)
		{
			...
			glUniform1ui(17, shadowCaster->component<ShadowMap::ShadowMapComponent>().m_algorithm);
			glUniform1ui(18, shadowCaster->component<ShadowMap::ShadowMapComponent>().m_precision);
			glUniform2fv(19, 1, glm::value_ptr(shadowCaster->component<ShadowMap::ShadowMapComponent>().m_exponentialConstants));

			// Upload the light transform
			glUniformMatrix4fv(20, 1, GL_FALSE, glm::value_ptr(transform.m_transform));
			glUniform1f(21, transform.m_isPerspective ? 1.0f : 0.0f);
			glUniform1f(22, transform.m_near);
			glUniform1f(23, transform.m_far);
