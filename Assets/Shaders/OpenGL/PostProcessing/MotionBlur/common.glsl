...
//////////////////////////////////////////////////
//  Samplers
layout (binding = TEXTURE_POST_PROCESS_1) uniform sampler2DArray sScene;
layout (binding = TEXTURE_POST_PROCESS_2) uniform sampler2D sTileMax;
layout (binding = TEXTURE_POST_PROCESS_3) uniform sampler2D sNeighborMax;
...
////////////////////////////////////////////////////////////////////////////////
float random2DRange(const vec2 co, const float mn, const float mx)
{
    return mn + random2D(co) * (mx - mn);
}
