...
*  --------------
*
*  Packs four uints with a bit size of X, Y, Z and W bits into a single value.
*
*******************************************************************************/
...
uvec4 unpackHalf4xXYZWui(uint v, uvec4 s)
{
    return uvec4(unpackHalf4xXYZWui_v1(v, s), unpackHalf4xXYZWui_v2(v, s), unpackHalf4xXYZWui_v3(v, s), unpackHalf4xXYZWui_v4(v, s));
}
...
uint packHalf2x16ui(uvec2 v)
{
    return (v.y << 16 | (v.x & 0xFFFFFFFF));
}

// Unpacks the first (x) component of a packed uvec2 value.
uint unpackHalf2x16ui_v1(uint v)
{
    return (v << 16) >> 16;
}

// Unpacks the second (y) component of a packed uvec2 value.
uint unpackHalf2x16ui_v2(uint v)
{
    return v >> 16;
}

// Unpacks two 16-bit uints packed into a single 32-bit value.
uvec2 unpackHalf2x16ui(uint v)
{
